...
public class Main extends Application {
	...
	searchForm = new Scene(tableView, 600, 500);
    ...
    private ObservableList<Developer> getDevelopers() {
        return FXCollections.observableArrayList(
                new Developer(1, "Samantha Stuart", "samantha.stuart@contoso.com", "true", "CA"),
                new Developer(2, "Tom Marks", "tom.marks@contoso.com", "true", "NY"),
                new Developer(3, "Stuart Gills", "stuart.gills@contoso.com", "true", "MA"),
                new Developer(4, "Nicole Williams", "nicole.williams@contoso.com", "true", "MI")
        );
    }
	...
	GridPane.setConstraints(nameLabel, 90, 80);

	TextField nameInput = new TextField();
	nameInput.setPromptText("Email Address");
	GridPane.setConstraints(nameInput, 91, 80);

	Label passwordLabel = new Label("Password:");
	GridPane.setConstraints(passwordLabel, 90, 81);

	PasswordField passwordInput = new PasswordField();
	passwordInput.setPromptText("Password");
	GridPane.setConstraints(passwordInput, 91, 81);

	Button loginButton = new Button("Log in");
	GridPane.setConstraints(loginButton, 91, 82);

	Button registerButton = new Button("Create Account");
	GridPane.setConstraints(registerButton, 91, 82);
